"""Quick gamma+threshold sweep for seed123."""
import sys, time
...
config, tokenizer, ckpt = load_checkpoint('outputs/mainline_seed123/best.pt', device)
...
print('Extracting logits...', flush=True)
all_logits = []
for seq in seqs:
...
print(f'FINAL: {best_cfg} F1={best_f1:.4f}')
